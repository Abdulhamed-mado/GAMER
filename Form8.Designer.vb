...
Partial Class Form8
    ...
    Private Sub InitializeComponent()
        ...
        Me.Button3.Location = New System.Drawing.Point(171, 80)
        ...
        Me.ComboBox1.Items.AddRange(New Object() {"المدار الجديد", "ليبيانا", "ليبيا للاتصالات و التقنية", "هاتف ليبيا"})
        ...
        Me.Text = "صفحة المبيعات-كروت الاتصالات المحلية"
